...
(function($) {
  ...
  CRM.config.resourceCacheCode = "txSiBen_US";
  CRM.config.quickAdd = [{"entity":"Individual","path":"civicrm\/quick-add\/Individual","title":"New Individual","icon":"fa-user"},{"entity":"Organization","path":"civicrm\/quick-add\/Organization","title":"New Organization","icon":"fa-building"}];
